...
<div id="Information" class="tabcontent">
	<div class="wrapper">
	  <img src="../modules/cointopay_direct_sofort/views/img/invoice.png" style="float:right;"/>
	  <h2 class="cointopay-sofort-information-header">Accept Bitcoin, Litecoin, Ethereum and other digital currencies on your PrestaShop store with Cointopay</h2><br/>
	  ...
	  <p>
	  	<ul>
	  		<li>Install the Cointopay Direct Sofort module on PrestaShop</li>
	  ...
	  <img src="../modules/cointopay_direct_sofort/views/img/currencies.png" style="float:right;"/>
	  <p class="sign-up"><br/>
