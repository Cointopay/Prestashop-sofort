...
$(document).ready(function () {
    ...
    var merchant_id = $("#COINTOPAY_DIRECT_SOFORT_MERCHANT_ID").val();
    getCoin(merchant_id);

    $("#COINTOPAY_DIRECT_SOFORT_MERCHANT_ID").keyup(function () {
        var id = this.value;
        getCoin(id);
    });
});
...
function getCoin(id) {
    ...
    var currency_url = '../modules/cointopay_direct_sofort/ajaxcall.php';
    if (id.length > 0) {
        $.ajax({
            url: currency_url,
            type: "POST",
