...
class Cointopay_Direct_SofortValidationModuleFrontController extends ModuleFrontController
{
    /**
    ...
    public function postProcess()
    {
        ...
        foreach (Module::getPaymentModules() as $module) {
            if ($module['name'] == 'cointopay_direct_sofort') {
                $authorized = true;
                break;
            }
        }
        ...
        $this->module->validateOrder($cart->id, Configuration::get('COINTOPAY_DIRECT_SOFORT_PENDING'), $total, $this->module->displayName, NULL, array(), (int)$currency->id, false, $customer->secure_key);
		$link = new Link();
        $success_url = '';
