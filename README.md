...
1. Download <https://github.com/Cointopay/Prestashop-sofort/archive/refs/heads/main.zip>
...
5. Find **Cointopay Direct Sofort** and click **Configure** button to next to it, then click **Proceed with the installation**.
